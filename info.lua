...
t.id = "NyakoFox:VLIB" -- Something unique: use your name, a colon, and then the plugin name
...
t.version = "1.5.1"  -- The current version of this plugin, can be anything you want
