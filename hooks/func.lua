...
function VLIB_SetupCanvases()
    ...
    VLIB_canvases = {
        ...
        spritesTexture = tilesets["sprites.png"].img,
        ...
        teleporterTexture = tilesets["teleporter.png"].img,
        entcoloursTexture = tilesets["entcolours.png"].img,
        image0Texture = VLIB_LoadFile("levelcomplete"),
        image1Texture = VLIB_LoadFile("minimap"),
        image2Texture = VLIB_LoadFile("covered"),
        image3Texture = VLIB_LoadFile("elephant", true),
        image4Texture = VLIB_LoadFile("gamecomplete"),
