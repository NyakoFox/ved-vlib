...
if (not VLIB_IsVed2X()) then
    VLIB_IMAGE_PLAY = love.graphics.newImage(VLIB_PLUGIN_PATH .. "themes/classic/ui/images/vlib_play_hq.png")
    VLIB_IMAGE_PLAY:setFilter("nearest", "nearest")

    VLIB_IMAGE_PLAYSTOP = love.graphics.newImage(VLIB_PLUGIN_PATH .. "themes/classic/ui/images/vlib_playstop_hq.png")
